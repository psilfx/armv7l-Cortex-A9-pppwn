...
echo "alias pppwn_ctl='sh /opt/etc/pppwn_ctl'" >> "/opt/etc/profile"
alias pppwn_ctl="sh /opt/etc/pppwn_ctl"
echo ""
echo "========================================"
echo -e "PPPWN доступен по команде: \033[1;33mpppwn_ctl { start | stop | restart | help | web_start }\033[1;37m"
echo "========================================"
echo ""
echo "========================================"
